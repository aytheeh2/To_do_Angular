...
router=SimpleRouter()
router.register('alltasks',views.Alltaskview)
router.register('notcompletedtasks',views.Notcompletedtaskview)
router.register('completedtasks',views.Completedtaskview)
